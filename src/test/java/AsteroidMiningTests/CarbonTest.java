...
class CarbonTest {
    ...
    void testResourceType() {
        Assertions.assertEquals("Carbon", carbon.getType(), "Resource type should be Carbon");
    }
    ...
    @Test
    void testResourceId() {
        Assertions.assertEquals(AsteroidMining.ID.Carbon, carbon.getId(), "Resource ID should be set to Carbon");
    }
    ...
    void testImageLoaded() {
        Assertions.assertNotNull(carbon.getImg(), "Image should be loaded for Carbon resource");
        Assertions.assertTrue(carbon.getImg() instanceof BufferedImage, "Image should be an instance of BufferedImage");
    }
}
